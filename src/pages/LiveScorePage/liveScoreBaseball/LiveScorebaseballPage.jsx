...
import LiveScorebaseballMobilePage from "./LiveScorebaseballMobilePage";
...
const LiveScorebaseballPage = ({ setMobileMenu, mobileMenu , sportsType, setSportsType }) => {
  ...
  return (
    <Wrapper>
      <ContentsContainer>
        ...
        <LiveScorebaseballMobilePage sportsType={sportsType}></LiveScorebaseballMobilePage>
...
export default LiveScorebaseballPage;