...
import LiveScoreVolleyballMobile from "./LiveScoreVolleyballMobile";
...
const LiveScoreVolleyball = ({ setMobileMenu, mobileMenu , sportsType, setSportsType }) => {
  ...
  return (
    <Wrapper>
      <ContentsContainer>
        ...
        <LiveScoreVolleyballMobile sportsType={sportsType}></LiveScoreVolleyballMobile>
...
export default LiveScoreVolleyball;